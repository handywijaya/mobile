...
public class Lantai_9_5 extends TourClassActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivMoveToilet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(getApplicationContext(), Lantai_9_7.class);
                animateFadeOutButtonBegin(layout);
                animateScaleOutBegin(v);
            }
        });
        ...
        ivEnter903.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                blurDialog = new BlurDialog().newInstance(R.layout.dialog_fragment_information, Lantai_9_5.this, floorInformation + 1, info);
