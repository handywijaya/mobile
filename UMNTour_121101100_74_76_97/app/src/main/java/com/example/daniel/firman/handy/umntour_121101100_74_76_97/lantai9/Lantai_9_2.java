...
public class Lantai_9_2 extends TourClassActivity {
        ...
        ivElevator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(buttonClick == 1) {
                    ...
                    blurDialog = new BlurDialog().newInstance(R.layout.dialog_fragment_elevator, Lantai_9_2.this, floorInformation, info);
